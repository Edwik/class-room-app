  ...
  return (
    <div className="App" style={{display: 'flex', flexDirection: 'row', height:"100vh"}}>
      ...
      <div className="Col2" style={{width: '25%', display: 'flex', flexDirection: 'column'}}>
        <iframe title="YOUTUBE" width="100%" height="300" src={process.env.ID} frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>
        <iframe  title="CHAT"allowfullscreen="" frameborder="0" height="100%" src={process.env.CHAT} width="100%"></iframe>
      </div>
